        ...
        <Col className="actividad" md={10}>
          ...
          <div className="center-act10">
            ...
            <input
              ...
              onChange={(e) =>
                handleEvalInputChange("eval_4_1", e.target.value)
              }
            />
            <InlineMath>{`) = `}</InlineMath>
            <input
              ...
              onChange={(e) =>
                handleEvalInputChange("eval_4_2", e.target.value)
              }
            />
            <br />
            <br />
            ...
            <input
              ...
              onChange={(e) =>
                handleEvalInputChange("eval_5_1", e.target.value)
              }
            />
            <InlineMath>{`) = `}</InlineMath>
            <input
              ...
              onChange={(e) =>
                handleEvalInputChange("eval_5_2", e.target.value)
              }
            />
          </div>
        </Col>
